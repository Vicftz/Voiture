...
public class VoitureCitadine implements Voiture {
     ...
     */
    public VoitureCitadine(){
    }
    public VoitureCitadine(String marque, String couleur) {
        // initialisation des variables d'instance
        this.marque = marque;
        this.couleur = couleur;
    }

    public VoitureCitadine(String marque, String couleur, Chassis chassis) {
        // initialisation des variables d'instance
        this(marque, couleur);
        this.chassis = chassis;
    }

    public VoitureCitadine(String marque, String couleur, Chassis chassis, ArrayList<Roue> roues) {
        // initialisation des variables d'instance
    ...
    public VoitureCitadine removeRoue(Roue roue) {
